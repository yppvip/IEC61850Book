(function () {
  ...
  const groups = [
    { id: 'library', label: '标准文库', entry: 'standard-library-overview.html', items: [['standard-library-overview.html', '概论：体系与模型'], ['standard-terms.html', '第 2 部分：术语导读'], ['abbreviation-index.html', '缩写、全拼、中文名与功能'], ['standard-model-index.html', 'IEC 61850 标准模型'], ['engineering-files.html', 'SCL 与工程交换文件']] },
  ...
  const standardTree = '<details open><summary>DL/T 860</summary><ul><li><a class="' + (current === 'standard-library-overview.html' ? 'current' : '') + '" href="standard-library-overview.html">概论：体系与模型</a></li><li><details open><summary>DL/Z 860.1</summary><ul><li><span>2004（版本资料待整理）</span></li><li><span>2018（版本资料待整理）</span></li></ul></details></li><li><a class="' + (current === 'standard-terms.html' ? 'current' : '') + '" href="standard-terms.html">第 2 部分：术语导读</a></li><li><a class="' + (current === 'abbreviation-index.html' ? 'current' : '') + '" href="abbreviation-index.html">缩写、全拼、中文名与功能</a></li><li><a class="' + (current === 'standard-model-index.html' ? 'current' : '') + '" href="standard-model-index.html">类型与标准模型索引</a></li><li><a class="' + (current === 'engineering-files.html' ? 'current' : '') + '" href="engineering-files.html">SCL 与工程交换文件</a></li><li>DL/T 860.3 ～ 860.6（待整理）</li><li>DL/T 860.71 ～ 860.74（待整理）</li><li>DL/T 860.81（待整理）</li></ul></details><details><summary>IEC 61850（待整理）</summary></details><details><summary>相关国家 / 行业标准（待整理）</summary></details>';
